...
Mintlify provides a powerful API for interacting with various AI functionalities, including HTTP requests to a server and a Node.js SDK. This documentation covers the usage of both the HTTP API and the Node.js SDK.
